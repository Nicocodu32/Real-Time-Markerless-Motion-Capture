...
| num | name              | fps | nb cam              | Multimodal        | MulP | Open | date  | author         | conf/journ | output | MPJPE(mm) | ang | MJRE(°) | method calc | dataset comp | comments | link |
| --- | ----------------- | --- | ------------------- | ----------------- | ---- | ---- | ----- | -------------- | ---------- | ------ | --------- | --- | ------- | ----------- | ------------ | -------- | ---- |
...
| name          | Real or Synth | Tools used for GT | comments | link |
| ------------- | ------------- | ----------------- | -------- | ---- |
